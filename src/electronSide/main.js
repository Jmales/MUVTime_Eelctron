...
function createWindow() {
    ...
    var closedPanels = Helper.closedPanels;
                    ...
                    click() {
                        dialog.showOpenDialog(
                            win,
                            {
                                ...
                                //Open Video Panel, if it isn't opened
                                if(menu.items[4].submenu.items[0].submenu.
                                    items[panelEnum.Vid].enabled === true){
                    ...
                    submenu: [
                        {
                            ...
                            enabled:closedPanels[panelEnum.Vis],
                            click (){
                        ...
                        {
                            label: "Time Series",
                            enabled:closedPanels[panelEnum.Time],
                            click (){
                        ...
                        {
                            label: "Video",
                            enabled:closedPanels[panelEnum.Vid],
                            click (){
                                win.webContents.send("newPanel", panelEnum.Vid);
                                //Change menu dinamically
                                menu.items[4].submenu.items[0].submenu.
                        ...
                        {
                            label: "3D",
                            enabled:closedPanels[panelEnum.XYZ],
                            click (){
